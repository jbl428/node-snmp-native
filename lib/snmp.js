...
function encode(pkt) {
    ...
    pkt.pdu.varbinds.forEach(function (vb) {
        ...
        switch (vb.type) {
            case asn1ber.types.Null:
                val = asn1ber.encodeNull();
                break;
            case asn1ber.types.Integer:
                val = asn1ber.encodeInteger(vb.value);
                break;
            case asn1ber.types.Gauge:
            ...
            case asn1ber.types.ObjectIdentifier:
                ...
                break;
            case asn1ber.types.Counter:
                val = asn1ber.encodeCounter(vb.value);
                break;
            case asn1ber.types.TimeTicks:
